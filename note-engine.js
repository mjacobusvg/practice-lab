...
- Solution-focused / problem-solving / behavioral activation — time-limited, targeted work on a single presenting problem: solution-focused steps, concrete problem-solving, or scheduling values-based activity. Cue: the visit zeroed in on one problem and worked it directly. Name the ACTUAL modality ("Solution-focused therapy", "Problem-solving therapy", or "Behavioral activation") — NEVER label it "brief intervention" or "brief focused intervention," which are session formats, not billable modalities.
