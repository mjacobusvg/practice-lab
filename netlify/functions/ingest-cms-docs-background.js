// netlify/functions/ingest-cms-docs-background.js
// Background function (up to 15 minutes) to fetch CMS public domain documents,
// extract text, embed them, and upsert into the posts table.
// POST with { "secret": "your-backfill-secret" }
// Returns 202 immediately — check Netlify function logs for progress.
...
exports.handler = async function(event, context) {
  ...
  // Check Netlify function logs for progress
  const response = {
    statusCode: 202,
    headers: CORS,
    body: JSON.stringify({ message: 'CMS ingestion started. Check function logs for progress.' })
  };
