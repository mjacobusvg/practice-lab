...
exports.handler = async function(event) {
  ...
  // (PHI) + recipient address in Supabase (no BAA). Keep it closed unconditionally until that
  // PHI is moved to S3 AND a mail-vendor BAA is executed (see BAA-AND-PHI-ROUTING.md §6).
