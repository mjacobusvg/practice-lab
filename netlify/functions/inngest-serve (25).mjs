...
SYMPATHETIC OVERDRIVE RULE: When the answer identifies sympathetic overdrive, adrenergic spillover, or adrenergic activation as the most likely cause rather than serotonin syndrome, do NOT recommend stopping or discontinuing the medication immediately. The correct guidance for sympathetic overdrive is: hold and evaluate, check vitals, consider dose reduction if stable, monitor. Recommending immediate discontinuation for sympathetic overdrive is clinically wrong and must never appear in the answer.
