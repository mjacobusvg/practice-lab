...
1. What to do — one direct actionable sentence based on your Step 2 conclusion. No preamble, no "it depends." Multiple components go in Required elements.

2. Required elements — specific components as a clean line-item list, one per line. Never fold into a paragraph.
